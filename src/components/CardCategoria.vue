...
<template>
   <article class="categoria">
    <header class="categoria__cabecalho">
        ...
        <img :src="`/imagens/icones/categorias_ingredientes/${categoria.imagem}`" :alt="`imagem de ${categoria.nome} que representa a categoria do ingrediente, `" class="categoria__imagem">
